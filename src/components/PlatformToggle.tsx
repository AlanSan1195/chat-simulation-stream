...
const PLATFORMS: Record<Platform, { color: string; label: string; textColor: string }> = {
  twitch: { color: "#9146FF", label: "Twitch", textColor: "#ffffff" },
  kick: { color: "#53FC18", label: "Kick", textColor: "#0a1a00" },
};
