...
export default function PlatformToggle() {
  ...
  return (
    <button
      ...
      className="flex items-center gap-2  px-3 py-1.5  border-[1.1px] border-black/40 dark:border-white/20 bg-bg-secundary  dark:bg-white/5  dark:hover:bg-white/10 transition-colors text-xs font-mono select-none"
    >
      <span
